<?php if (!defined('THINK_PATH')) exit();?><!--
	...
	描述：分页参数
-->
<form id="pagerForm" action="/zyq/index.php/Admin/Carousel" method="post">
...
<div class="pageHeader">
	<form rel="pagerForm" onsubmit="return navTabSearch(this);" action="/zyq/index.php/Admin/Carousel/index" method="post">
	<div class="searchBar">
...
<div class="pageContent">
	...
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="/zyq/index.php/Admin/Carousel/add" target="dialog" mask="true" width="800" height="480"><span>新增</span></a></li>
			<li><a class="delete" href="/zyq/index.php/Admin/Carousel/del/id/{sid}" target="ajaxTodo" title="你确定要删除吗？" warn="请选择"><span>删除</span></a></li>
			<li><a class="edit" href="/zyq/index.php/Admin/Carousel/edit/id/{sid}" target="dialog" mask="true" width="800" height="480" warn="请选择"><span>编辑</span></a></li>
			<li class="line">line</li>
			<li><a class="icon" href="/zyq/index.php/Admin/Carousel/upload/id/{sid}" target="dialog" mask="true" width="800" height="480" warn="请选择"><span>上传图片</span></a></li>
		</ul>
	</div>
	...
	<table class="table" width="100%" asc="asc" desc="desc" layoutH="138">
		<thead>
			<tr>
				...
				<th width="200" orderField="url" <?php if(($sort) == "url"): ?>class="<?php echo ($order); ?>"<?php endif; ?>>超链接</th>
				<th width="120" orderField="title" <?php if(($sort) == "title"): ?>class="<?php echo ($order); ?>"<?php endif; ?>>标题</th>
				<th orderField="alt" <?php if(($sort) == "alt"): ?>class="<?php echo ($order); ?>"<?php endif; ?>>提示</th>
				<th orderField="sort" <?php if(($sort) == "sort"): ?>class="<?php echo ($order); ?>"<?php endif; ?>>排序</th>
				<th width="120" orderField="enable" <?php if(($sort) == "enable"): ?>class="<?php echo ($order); ?>"<?php endif; ?>>是否可用</th>
			</tr>
		</thead>
		<tbody>
