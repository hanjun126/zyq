<?php if (!defined('THINK_PATH')) exit();?><!--
	...
	描述：分页参数
-->
<form id="pagerForm" action="/zyq/index.php/Admin/Admin" method="post">
...
<div class="pageHeader">
	<form rel="pagerForm" onsubmit="return navTabSearch(this);" action="/zyq/index.php/Admin/Admin" method="post">
	<div class="searchBar">
...
<div class="pageContent">
	...
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="/zyq/index.php/Admin/Admin/add" target="dialog" mask="true" width="800" height="480"><span>新增</span></a></li>
			<li><a class="delete" href="/zyq/index.php/Admin/Admin/del/id/{sid}" target="ajaxTodo" title="你确定要删除吗？" warn="请选择"><span>删除</span></a></li>
			<li><a class="edit" href="/zyq/index.php/Admin/Admin/edit/id/{sid}" target="dialog" mask="true" width="800" height="480" warn="请选择"><span>编辑</span></a></li>
			<li class="line">line</li>
			<li><a class="icon" href="/zyq/index.php/Admin/Admin/pwd/id/{sid}" target="dialog" mask="true" width="800" height="480" warn="请选择"><span>修改密码</span></a></li>
		</ul>
	</div>
	...
	<table class="table" width="100%" asc="asc" desc="desc" layoutH="138">
		<thead>
			<tr>
				...
				<th width="200" orderField="acount" <?php if(($sort) == "acount"): ?>class="<?php echo ($order); ?>"<?php endif; ?>>账号</th>
				...
				<th width="120" orderField="pri" <?php if(($sort) == "pri"): ?>class="<?php echo ($order); ?>"<?php endif; ?>>权限</th>
