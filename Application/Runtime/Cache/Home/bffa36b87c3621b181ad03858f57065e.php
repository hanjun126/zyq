...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/zyq/Public/style/shopping/succeed.css"/>
	</head>
	<body>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		<div class="container block-succeed">
			<div class="line">
				<div class="process flex-flex-1"></div>
			</div>
			<div class="flex-column tip">
				<div class="txt">
					<i class="icon-ok"></i>
					恭喜您，你的订单支付成功！
				</div>
				<div>
					<span class="osn">你的订单号：100000000000</span>
					<a class="look" href="/zyq/index.php/Home/shopping/index"><i class="icon-signin"></i>&nbsp;查看订单详情</a>
					<a class="cn" href="/zyq/index.php/Home/shopping/index"><i class="icon-play"></i>&nbsp;继续看看</a>
				</div>
			</div>
		</div>
