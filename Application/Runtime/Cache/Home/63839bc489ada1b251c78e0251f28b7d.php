...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/zyq/Public/style/goods/index.css"/>
	</head>
	<body>
		...
		<div class="container">
			<div class="line">
				<div class="flex-flex-1 block-indicate">
					...
					<a href="/zyq/index.php/Home/Goods/index">商品中心</a>
					&nbsp;<i class="icon-double-angle-right"></i>&nbsp;
					<span>全部商品</span>
				</div>
			</div>
			
			<div class="line margin-tb-20px">
