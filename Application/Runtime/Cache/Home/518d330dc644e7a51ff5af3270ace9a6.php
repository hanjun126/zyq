...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/zyq/Public/style/goods/cases.css"/>
	</head>
	<body>
	...
	<div class="container nav">
		<div class="line flex-justify-content-sb">
			...
			<div class="cl">
				...
				<a href="/zyq/index.php/Home/Goods/cases">案例展示</a>
		...
		<div class="container">
			<div class="line">
				<div class="flex-flex-1 block-indicate">
					您的位置：
					<a href="">首页</a>	&nbsp;<i class="icon-double-angle-right"></i>&nbsp;
					<span>案例展示</span>
				</div>
			</div>
			
			<div class="line flex-wrap block-cases">
				<?php $__FOR_START_7056__=1;$__FOR_END_7056__=10;for($i=$__FOR_START_7056__;$i < $__FOR_END_7056__;$i+=1){ ?><div class="item flex-row">
